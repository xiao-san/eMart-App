                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                                  ...
                                  ).box.color(whiteColor).margin(const EdgeInsets.symmetric(horizontal: 4)).padding(const EdgeInsets.all(12)).roundedSM.make();
                        },
                      ).box.margin(const EdgeInsets.symmetric(horizontal: 8)).make(),
                    ],
                  ),
                ),
              ),
